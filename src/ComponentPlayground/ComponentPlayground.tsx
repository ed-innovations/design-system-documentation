...
export default function App() {
  // wrapper so it looks like your current "playground-safe centering"
  return (
...
`,
    ...
    "/Login.css": {
        code: `/* --- Playground-safe centering --- */
.login-wrapper {
  min-height: 100vh;
  display: grid;
  place-items: center;
...
.email-field { top: 224px; }
.password-field { top: 304px; }
    ...
    return (
        <SandpackProvider template="react-ts" files={files}>
            <SandpackLayout>
                ...
                <SandpackPreview style={{ minHeight: 520 }} />
            </SandpackLayout>
        </SandpackProvider>
    );
}
